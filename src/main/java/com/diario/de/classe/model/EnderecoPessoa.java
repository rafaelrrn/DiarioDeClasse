...
public class EnderecoPessoa {
    ...
    @ManyToOne
    @JoinColumn(name = "id_pessoa", nullable = false, referencedColumnName = "id_pessoa", foreignKey = @ForeignKey(name = "fk_id_pessoa"))
    private Pessoa pessoa;

    @ManyToOne
    @JoinColumn(name = "id_endereco", nullable = false, referencedColumnName = "id_endereco", foreignKey = @ForeignKey(name = "fk_id_endereco"))
