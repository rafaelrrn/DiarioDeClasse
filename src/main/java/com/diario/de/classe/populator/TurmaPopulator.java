...
@Component
public class TurmaPopulator {
    final private static Logger LOG = LogManager.getLogger(TurmaPopulator.class);

    public Turma atualizaTurma(Turma recebido, Turma doBanco) {
